...
namespace Service
{
    public class MenuService : IMenuService
    {
        ...
        public async Task<bool> Del(string userId)
        {
            var info = _db.Queryable<Menu>().First(p => p.Id == userId);
        ...
        public async Task<List<MenuRes>> Get(MenuReq req, string userId)
        {
            //Super adminかどうかを判断する
        ...
        public async Task<bool> Setting(string rid, string mids)
        {
